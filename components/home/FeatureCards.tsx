...
export default function FeatureCards() {
  return (
    <section className="pb-0.5 pt-4 md:pt-6 w-full max-w-screen-2xl mx-auto">
              ...
              <div key={title} className="group block w-full">
                ...
                <div className="w-full h-full flex flex-row items-center justify-center gap-2.5 px-1 transition-all duration-300 rounded-2xl bg-brand-silver/10 text-brand-gris  py-1 ">
                  ...
                  <div className="flex flex-col min-w-0 text-center justify-center h-full  ">
                    ...
                    <span className="text-[6px] sm:text-[11px] md:text-xs font-medium leading-tight mt-0.5 min-h-[1.8em] flex items-start ">
