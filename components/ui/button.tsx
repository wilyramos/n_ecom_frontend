    ...
    variants: {
      variant: {
        ...
        primary:
          "bg-brand-charcoal text-white hover:bg-brand-black",
        accent:
          "bg-brand-action text-brand-silver-border hover:bg-brand-action/90",
        secondary:
          "bg-brand-silver text-brand-charcoal border border-brand-silver-border hover:bg-brand-gris/30",
        outline:
        ...
        success:
          "bg-brand-action/20 text-brand-charcoal border border-brand-action hover:bg-brand-action/30",
        warning:
          "bg-brand-action-muted text-brand-charcoal hover:bg-brand-action/40",
        destructive:
