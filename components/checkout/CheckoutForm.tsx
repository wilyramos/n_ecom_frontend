...
export default function CheckoutForm({ user }: Props) {
    ...
    const handleTabChange = (value: string) => {
        ...
        if (mode === "pickup") {
            // Setea valores fijos de la tienda física para la orden
            ...
            // Restablece los campos vacíos para que el usuario los llene
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6  text-foreground">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="flex flex-col gap-1.5">
                        ...
                        <Input
                            ...
                            className={cn(
                                "border-border-default focus:ring-brand-charcoal",
                                errors.nombre && "border-destructive focus:ring-destructive"
                            )}
                        />
                        <div className="min-h-[16px]">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <Input
                            ...
                            className={cn(
                                "border-border-default focus:ring-brand-charcoal",
                                errors.apellidos && "border-destructive focus:ring-destructive"
                            )}
                        />
                        <div className="min-h-[16px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-3">
                        ...
                        <Controller
                            ...
                            render={({ field }) => (
                                <Select onValueChange={field.onChange} value={field.value}>
                                    <SelectTrigger className="w-full border-border-default focus:ring-brand-charcoal">
                    ...
                    <div className="flex flex-col gap-1.5 sm:col-span-4">
                        ...
                        <Input
                            ...
                            className={cn(
                                "border-border-default focus:ring-brand-charcoal",
                                errors.numeroDocumento && "border-destructive focus:ring-destructive"
                            )}
                        />
                        <div className="min-h-[16px]">
                    ...
                    <div className="flex flex-col gap-1.5 sm:col-span-5">
                        ...
                        <Input
                            ...
                            className={cn(
                                "border-border-default focus:ring-brand-charcoal",
                                errors.telefono && "border-destructive focus:ring-destructive"
                            )}
                        />
                        <div className="min-h-[16px]">
            ...
            {/* ── BLOQUE 2: INFORMACIÓN DE ENTREGA EN FUNCIÓN AL TAB ── */}
            <div className="p-4 rounded-2xl border border-border-default bg-surface-primary space-y-2">
                <div className="flex items-center gap-2 border-b border-border-default pb-2">
            ...
            <div className="pt-2">
                <Button
                    ...
                    className="w-full bg-action-primary text-fg-inverse hover:bg-action-primary-hover transition-colors h-11 font-semibold text-sm rounded-lg"
                >
                    {loading ? (
